...
non_firing_count = np.zeros(total_samples)
...
# save results
np.save(experiment_path + 'result' + str(experiment_number) + '/delay', connections['input'].delay)
np.save(experiment_path + 'result' + str(experiment_number) + '/weights', connections['input'].W)
np.save(experiment_path + 'result' + str(experiment_number) + '/theta', neuron_groups['spiking'].theta)

np.save(experiment_path + 'result' + str(experiment_number) + '/training_rates', result_spike_activity)
np.save(experiment_path + 'result' + str(experiment_number) + '/non_firing_count', non_firing_count)
